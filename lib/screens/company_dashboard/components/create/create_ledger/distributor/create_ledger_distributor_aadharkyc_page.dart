...
class CreateLedgerDistributorAadharKycPage extends StatefulWidget {
  const CreateLedgerDistributorAadharKycPage({super.key});

  @override
  State<CreateLedgerDistributorAadharKycPage> createState() =>
      _CreateLedgerDistributorAadharKycPageState();
}

class _CreateLedgerDistributorAadharKycPageState
    extends State<CreateLedgerDistributorAadharKycPage> {
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              30.heightBox,
                              CustomButton(
                                onPress: ()=> Get.toNamed(Routes.CREATE_lEDGER_DISTRIBUTOR_EKYC_PAGEVIEW),
                                borderRadius: 8,
                                height: 40,
                                width: 130,
                                text: 'Verify',
            ...
            child: Column(
              ...
              children: [
                ...
                CustomFormField(
                  readOnly: true,
                  height: 16,
                  controller: createLedgerDistributorController.nameController,
                  label: 'Enter',
                ),
                8.heightBox,
                CustomRichText(
                ...
                CustomFormField(
                  readOnly: true,
                  height: 16,
                  controller: createLedgerDistributorController.surnameController,
                  label: 'Surname',
                ),
                8.heightBox,
                CustomRichText(
                ...
                Align(
                  ...
                  child: SizedBox(
                    ...
                    child: TextButton(
                        onPressed: () {
                          Get.toNamed(Routes.CREATE_lEDGER_DISTRIBUTOR_MANUAL_KYC_PAGEVIEW);
                        },
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [
