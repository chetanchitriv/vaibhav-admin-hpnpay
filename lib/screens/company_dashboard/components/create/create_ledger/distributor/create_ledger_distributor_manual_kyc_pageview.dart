...
class CreateLedgerDistributorManualKycPageView extends StatefulWidget {
  CreateLedgerDistributorManualKycPageView({Key? key}) : super(key: key);

  @override
  State<CreateLedgerDistributorManualKycPageView> createState() =>
      _CreateLedgerDistributorManualKycPageViewState();
}

class _CreateLedgerDistributorManualKycPageViewState
    extends State<CreateLedgerDistributorManualKycPageView> {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          6.heightBox,
          CustomFormField(controller: createLedgerDistributorController.aadharNumberController, label: 'Aadhar Number'),
          8.heightBox,
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
