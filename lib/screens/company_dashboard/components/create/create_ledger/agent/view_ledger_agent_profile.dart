...
class ViewLedgerAgentProfilePage extends StatefulWidget {
  ViewLedgerAgentProfilePage({super.key});

  @override
  State<ViewLedgerAgentProfilePage> createState() =>
      _ViewLedgerAgentProfilePageState();
}

class _ViewLedgerAgentProfilePageState extends State<ViewLedgerAgentProfilePage> {
  ...
  void loadSwitchState() async {
    ...
    setState(() {
      createLedgerAgentController.switchValue = prefs.getBool('switchValue') ?? false;
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: CustomAppBar(
          ...
          backgroundColor: whiteColor,
          child: Switch(
            value: createLedgerAgentController.switchValue,
            onChanged: (bool newValue) {
              setState(() {
                createLedgerAgentController.switchValue = newValue;
              });
          ...
          child: Column(
            ...
            children: <Widget>[
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: CustomFormField(
                          readOnly: true,
                          height: 16,
                          controller: createLedgerAgentController.partyNameController,
                          label: 'Party name',
                        ),
                      ),
                      8.heightBox,
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: CustomFormField(
                          ...
                          height: 16,
                          controller:
                          createLedgerAgentController.cityController,
                          label: 'City',
                        ),
                      ),
                    ],
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: CustomFormField(
                          ...
                          height: 16,
                          controller: createLedgerAgentController.pinCodeController,
                          label: 'Pincode',
                        ),
                      ),
                    ],
              ...
              CustomFormField(
                readOnly: true,
                height: 16,
                controller: createLedgerAgentController.salaryController,
                label: 'Level 3',
              ),
              8.heightBox,
              CustomRichText(
              ...
              CustomFormField(
                readOnly: true,
                height: 16,
                controller: createLedgerAgentController.minimumFileController,
                label: 'Enter',
              ),
              ...
              CustomFormField(
                readOnly: true,
                height: 16,
                controller: createLedgerAgentController.amountController,
                label: 'Enter',
              ),
                ...
                children: [
                  SizedBox(
                    ...
                    child: CustomFormField(
                      ...
                      height: 16,
                      controller:
                      createLedgerAgentController.continuePerformanceController,
                      label: 'Enter',
                    ),
                  ),
                  10.widthBox,
              ...
              Visibility(
                visible: createLedgerAgentController.switchValue == false,
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.start,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    CustomFormField(
                      height: 16,
                      controller: createLedgerAgentController.remarkController,
                      label: 'Enter',
                    ),
                    20.heightBox,
                    Align(
